...
onmessage = function(e) {
    ...
    switch(effect){
        ...
        case 'BLACK_WHITE':
                for (let i = 0; i < numPixels; i++) {
                    imgDataArray[i * 4] = BLACK_WHITE_Fn(imgDataArray[i * 4]);
                    imgDataArray[i * 4 +1] = BLACK_WHITE_Fn(imgDataArray[i * 4] + 1);
                    imgDataArray[i * 4 + 2] = BLACK_WHITE_Fn(imgDataArray[i * 4] + 2);
                }
                break;
        case 'REVERSE':
                for (let i = 0; i < numPixels; i++) {
